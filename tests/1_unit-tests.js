...
suite('Unit Tests', function(){
    ...
    test("correctly read a fractional input", () => {
        assert.strictEqual(convertHandler.getNum("1/22mi"), "1/22", "these numbers are not equal")
    })

    test("correctly read a fractional input with a decimal", () => {
        assert.strictEqual(convertHandler.getNum("1/22.2mi"), "1/22.2", "these numbers are not equal")
    })
